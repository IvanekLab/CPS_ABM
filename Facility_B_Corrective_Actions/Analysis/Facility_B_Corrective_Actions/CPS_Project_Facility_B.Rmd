...
round(mean(FAMD1$prob_cont_mon),2)
round(mean(FAMD1$prob_cont_tue),2)
round(mean(FAMD1$prob_cont_wed),2)
round(mean(FAMD1$prob_cont_thu),2)
round(mean(FAMD1$prob_cont_fri),2)
print('Cluster 1: Concentrations Mon-Fri')
round(mean(FAMD1$conc_mid_mon_mean),2)
round(mean(FAMD1$conc_mid_tue_mean),2)
round(mean(FAMD1$conc_mid_wed_mean),2)
round(mean(FAMD1$conc_mid_thu_mean),2)
round(mean(FAMD1$conc_mid_fri_mean),2)
print('Cluster 1: Probabilities Zone')
round(mean(FAMD1$prob_cont_wed[FAMD1$zone==1]),2)
round(mean(FAMD1$prob_cont_wed[FAMD1$zone==2]),2)
round(mean(FAMD1$prob_cont_wed[FAMD1$zone==3]),2)
print('Cluster 1: Concentrations Zone')
round(mean(FAMD1$conc_mid_wed_mean[FAMD1$zone==1]),2)
round(mean(FAMD1$conc_mid_wed_mean[FAMD1$zone==2]),2)
round(mean(FAMD1$conc_mid_wed_mean[FAMD1$zone==3]),2)
print('Cluster 1: Probabilities Water')
round(mean(FAMD1$prob_cont_wed[FAMD1$water=='wet']),2)
round(mean(FAMD1$prob_cont_wed[FAMD1$water=='dry']),2)
print('Cluster 1: Concentrations Water')
round(mean(FAMD1$conc_mid_wed_mean[FAMD1$water=='wet']),2)
round(mean(FAMD1$conc_mid_wed_mean[FAMD1$water=='dry']),2)
FAMD2 <- subset(agents,FAMDClusters==2)
summary(FAMD2)
print('Cluster 2: Probabilities Mon-Fri')
round(mean(FAMD2$prob_cont_mon),2)
round(mean(FAMD2$prob_cont_tue),2)
round(mean(FAMD2$prob_cont_wed),2)
round(mean(FAMD2$prob_cont_thu),2)
round(mean(FAMD2$prob_cont_fri),2)
print('Cluster 2: Concentrations Mon-Fri')
round(mean(FAMD2$conc_mid_mon_mean),2)
round(mean(FAMD2$conc_mid_tue_mean),2)
round(mean(FAMD2$conc_mid_wed_mean),2)
round(mean(FAMD2$conc_mid_thu_mean),2)
round(mean(FAMD2$conc_mid_fri_mean),2)
print('Cluster 2: Probabilities Zone')
round(mean(FAMD2$prob_cont_wed[FAMD2$zone==1]),2)
round(mean(FAMD2$prob_cont_wed[FAMD2$zone==2]),2)
round(mean(FAMD2$prob_cont_wed[FAMD2$zone==3]),2)
print('Cluster 2: Concentrations Zone')
round(mean(FAMD2$conc_mid_wed_mean[FAMD2$zone==1]),2)
round(mean(FAMD2$conc_mid_wed_mean[FAMD2$zone==2]),2)
round(mean(FAMD2$conc_mid_wed_mean[FAMD2$zone==3]),2)
print('Cluster 2: Probabilities Water')
round(mean(FAMD2$prob_cont_wed[FAMD2$water=='wet']),2)
round(mean(FAMD2$prob_cont_wed[FAMD2$water=='dry']),2)
print('Cluster 2: Concentrations Water')
round(mean(FAMD2$conc_mid_wed_mean[FAMD2$water=='wet']),2)
round(mean(FAMD2$conc_mid_wed_mean[FAMD2$water=='dry']),2)
FAMD3 <- subset(agents,FAMDClusters==3)
summary(FAMD3)
print('Cluster 3: Probabilities Mon-Fri')
round(mean(FAMD3$prob_cont_mon),2)
round(mean(FAMD3$prob_cont_tue),2)
round(mean(FAMD3$prob_cont_wed),2)
round(mean(FAMD3$prob_cont_thu),2)
round(mean(FAMD3$prob_cont_fri),2)
print('Cluster 3: Concentrations Mon-Fri')
round(mean(FAMD3$conc_mid_mon_mean),2)
round(mean(FAMD3$conc_mid_tue_mean),2)
round(mean(FAMD3$conc_mid_wed_mean),2)
round(mean(FAMD3$conc_mid_thu_mean),2)
round(mean(FAMD3$conc_mid_fri_mean),2)
print('Cluster 3: Probabilities Zone')
round(mean(FAMD3$prob_cont_wed[FAMD3$zone==1]),2)
round(mean(FAMD3$prob_cont_wed[FAMD3$zone==2]),2)
round(mean(FAMD3$prob_cont_wed[FAMD3$zone==3]),2)
print('Cluster 3: Concentrations Zone')
round(mean(FAMD3$conc_mid_wed_mean[FAMD3$zone==1]),2)
round(mean(FAMD3$conc_mid_wed_mean[FAMD3$zone==2]),2)
round(mean(FAMD3$conc_mid_wed_mean[FAMD3$zone==3]),2)
print('Cluster 3: Probabilities Water')
round(mean(FAMD3$prob_cont_wed[FAMD3$water=='wet']),2)
round(mean(FAMD3$prob_cont_wed[FAMD3$water=='dry']),2)
print('Cluster 3: Concentrations Water')
round(mean(FAMD3$conc_mid_wed_mean[FAMD3$water=='wet']),2)
round(mean(FAMD3$conc_mid_wed_mean[FAMD3$water=='dry']),2)
FAMD4 <- subset(agents,FAMDClusters==4)
summary(FAMD4)
print('Cluster 4: Probabilities Mon-Fri')
round(mean(FAMD4$prob_cont_mon),2)
round(mean(FAMD4$prob_cont_tue),2)
round(mean(FAMD4$prob_cont_wed),2)
round(mean(FAMD4$prob_cont_thu),2)
round(mean(FAMD4$prob_cont_fri),2)
print('Cluster 4: Concentrations Mon-Fri')
round(mean(FAMD4$conc_mid_mon_mean),2)
round(mean(FAMD4$conc_mid_tue_mean),2)
round(mean(FAMD4$conc_mid_wed_mean),2)
round(mean(FAMD4$conc_mid_thu_mean),2)
round(mean(FAMD4$conc_mid_fri_mean),2)
print('Cluster 4: Probabilities Zone')
round(mean(FAMD4$prob_cont_wed[FAMD4$zone==1]),2)
round(mean(FAMD4$prob_cont_wed[FAMD4$zone==2]),2)
round(mean(FAMD4$prob_cont_wed[FAMD4$zone==3]),2)
print('Cluster 4: Concentrations Zone')
round(mean(FAMD4$conc_mid_wed_mean[FAMD4$zone==1]),2)
round(mean(FAMD4$conc_mid_wed_mean[FAMD4$zone==2]),2)
round(mean(FAMD4$conc_mid_wed_mean[FAMD4$zone==3]),2)
print('Cluster 4: Probabilities Water')
round(mean(FAMD4$prob_cont_wed[FAMD4$water=='wet']),2)
round(mean(FAMD4$prob_cont_wed[FAMD4$water=='dry']),2)
print('Cluster 4: Concentrations Water')
round(mean(FAMD4$conc_mid_wed_mean[FAMD4$water=='wet']),2)
round(mean(FAMD4$conc_mid_wed_mean[FAMD4$water=='dry']),2)
FAMD5 <- subset(agents,FAMDClusters==5)
summary(FAMD5)
print('Cluster 5: Probabilities Mon-Fri')
round(mean(FAMD5$prob_cont_mon),2)
round(mean(FAMD5$prob_cont_tue),2)
round(mean(FAMD5$prob_cont_wed),2)
round(mean(FAMD5$prob_cont_thu),2)
round(mean(FAMD5$prob_cont_fri),2)
print('Cluster54: Concentrations Mon-Fri')
round(mean(FAMD5$conc_mid_mon_mean),2)
round(mean(FAMD5$conc_mid_tue_mean),2)
round(mean(FAMD5$conc_mid_wed_mean),2)
round(mean(FAMD5$conc_mid_thu_mean),2)
round(mean(FAMD5$conc_mid_fri_mean),2)
print('Cluster 5: Probabilities Zone')
round(mean(FAMD5$prob_cont_wed[FAMD5$zone==1]),2)
round(mean(FAMD5$prob_cont_wed[FAMD5$zone==2]),2)
round(mean(FAMD5$prob_cont_wed[FAMD5$zone==3]),2)
print('Cluster 5: Concentrations Zone')
round(mean(FAMD5$conc_mid_wed_mean[FAMD5$zone==1]),2)
round(mean(FAMD5$conc_mid_wed_mean[FAMD5$zone==2]),2)
round(mean(FAMD5$conc_mid_wed_mean[FAMD5$zone==3]),2)
print('Cluster 5: Probabilities Water')
round(mean(FAMD5$prob_cont_wed[FAMD5$water=='wet']),2)
round(mean(FAMD5$prob_cont_wed[FAMD5$water=='dry']),2)
print('Cluster 5: Concentrations Water')
round(mean(FAMD5$conc_mid_wed_mean[FAMD5$water=='wet']),2)
round(mean(FAMD5$conc_mid_wed_mean[FAMD5$water=='dry']),2)
```
...
summary(PCA1)
print('Cluster 1: Probabilities Mon-Fri')
round(mean(PCA1$prob_cont_mon),2)
round(mean(PCA1$prob_cont_tue),2)
round(mean(PCA1$prob_cont_wed),2)
round(mean(PCA1$prob_cont_thu),2)
round(mean(PCA1$prob_cont_fri),2)
print('Cluster 1: Concentrations Mon-Fri')
round(mean(PCA1$conc_mid_mon_mean),2)
round(mean(PCA1$conc_mid_tue_mean),2)
round(mean(PCA1$conc_mid_wed_mean),2)
round(mean(PCA1$conc_mid_thu_mean),2)
round(mean(PCA1$conc_mid_fri_mean),2)
print('Cluster 1: Probabilities Zone')
round(mean(PCA1$prob_cont_wed[PCA1$zone==1]),2)
round(mean(PCA1$prob_cont_wed[PCA1$zone==2]),2)
round(mean(PCA1$prob_cont_wed[PCA1$zone==3]),2)
print('Cluster 1: Concentrations Zone')
round(mean(PCA1$conc_mid_wed_mean[PCA1$zone==1]),2)
round(mean(PCA1$conc_mid_wed_mean[PCA1$zone==2]),2)
round(mean(PCA1$conc_mid_wed_mean[PCA1$zone==3]),2)
print('Cluster 1: Probabilities Water')
round(mean(PCA1$prob_cont_wed[PCA1$water=='wet']),2)
round(mean(PCA1$prob_cont_wed[PCA1$water=='dry']),2)
print('Cluster 1: Concentrations Water')
round(mean(PCA1$conc_mid_wed_mean[PCA1$water=='wet']),2)
round(mean(PCA1$conc_mid_wed_mean[PCA1$water=='dry']),2)
PCA2 <- subset(subagents,PCAClusters==2)
summary(PCA2)
print('Cluster 2: Probabilities Mon-Fri')
round(mean(PCA2$prob_cont_mon),2)
round(mean(PCA2$prob_cont_tue),2)
round(mean(PCA2$prob_cont_wed),2)
round(mean(PCA2$prob_cont_thu),2)
round(mean(PCA2$prob_cont_fri),2)
print('Cluster 2: Concentrations Mon-Fri')
round(mean(PCA2$conc_mid_mon_mean),2)
round(mean(PCA2$conc_mid_tue_mean),2)
round(mean(PCA2$conc_mid_wed_mean),2)
round(mean(PCA2$conc_mid_thu_mean),2)
round(mean(PCA2$conc_mid_fri_mean),2)
print('Cluster 2: Probabilities Zone')
round(mean(PCA2$prob_cont_wed[PCA2$zone==1]),2)
round(mean(PCA2$prob_cont_wed[PCA2$zone==2]),2)
round(mean(PCA2$prob_cont_wed[PCA2$zone==3]),2)
print('Cluster 2: Concentrations Zone')
round(mean(PCA2$conc_mid_wed_mean[PCA2$zone==1]),2)
round(mean(PCA2$conc_mid_wed_mean[PCA2$zone==2]),2)
round(mean(PCA2$conc_mid_wed_mean[PCA2$zone==3]),2)
print('Cluster 2: Probabilities Water')
round(mean(PCA2$prob_cont_wed[PCA2$water=='wet']),2)
round(mean(PCA2$prob_cont_wed[PCA2$water=='dry']),2)
print('Cluster 2: Concentrations Water')
round(mean(PCA2$conc_mid_wed_mean[PCA2$water=='wet']),2)
round(mean(PCA2$conc_mid_wed_mean[PCA2$water=='dry']),2)
PCA3 <- subset(subagents,PCAClusters==3)
summary(PCA3)
print('Cluster 3: Probabilities Mon-Fri')
round(mean(PCA3$prob_cont_mon),2)
round(mean(PCA3$prob_cont_tue),2)
round(mean(PCA3$prob_cont_wed),2)
round(mean(PCA3$prob_cont_thu),2)
round(mean(PCA3$prob_cont_fri),2)
print('Cluster 3: Concentrations Mon-Fri')
round(mean(PCA3$conc_mid_mon_mean),2)
round(mean(PCA3$conc_mid_tue_mean),2)
round(mean(PCA3$conc_mid_wed_mean),2)
round(mean(PCA3$conc_mid_thu_mean),2)
round(mean(PCA3$conc_mid_fri_mean),2)
print('Cluster 3: Probabilities Zone')
round(mean(PCA3$prob_cont_wed[PCA3$zone==1]),2)
round(mean(PCA3$prob_cont_wed[PCA3$zone==2]),2)
round(mean(PCA3$prob_cont_wed[PCA3$zone==3]),2)
print('Cluster 3: Concentrations Zone')
round(mean(PCA3$conc_mid_wed_mean[PCA3$zone==1]),2)
round(mean(PCA3$conc_mid_wed_mean[PCA3$zone==2]),2)
round(mean(PCA3$conc_mid_wed_mean[PCA3$zone==3]),2)
print('Cluster 3: Probabilities Water')
round(mean(PCA3$prob_cont_wed[PCA3$water=='wet']),2)
round(mean(PCA3$prob_cont_wed[PCA3$water=='dry']),2)
print('Cluster 3: Concentrations Water')
round(mean(PCA3$conc_mid_wed_mean[PCA3$water=='wet']),2)
round(mean(PCA3$conc_mid_wed_mean[PCA3$water=='dry']),2)
# PCA4 <- subset(subagents,PCAClusters==4)
# summary(PCA4)
# print('Cluster 4: Probabilities Mon-Fri')
# round(mean(PCA4$prob_cont_mon),2)
# round(mean(PCA4$prob_cont_tue),2)
# round(mean(PCA4$prob_cont_wed),2)
# round(mean(PCA4$prob_cont_thu),2)
# round(mean(PCA4$prob_cont_fri),2)
# print('Cluster 4: Concentrations Mon-Fri')
# round(mean(PCA4$conc_mid_mon_mean),2)
# round(mean(PCA4$conc_mid_tue_mean),2)
# round(mean(PCA4$conc_mid_wed_mean),2)
# round(mean(PCA4$conc_mid_thu_mean),2)
# round(mean(PCA4$conc_mid_fri_mean),2)
# print('Cluster 4: Probabilities Zone')
# round(mean(PCA4$prob_cont_wed[PCA4$zone==1]),2)
# round(mean(PCA4$prob_cont_wed[PCA4$zone==2]),2)
# round(mean(PCA4$prob_cont_wed[PCA4$zone==3]),2)
# print('Cluster 4: Concentrations Zone')
# round(mean(PCA4$conc_mid_wed_mean[PCA4$zone==1]),2)
# round(mean(PCA4$conc_mid_wed_mean[PCA4$zone==2]),2)
# round(mean(PCA4$conc_mid_wed_mean[PCA4$zone==3]),2)
# print('Cluster 4: Probabilities Water')
# round(mean(PCA4$prob_cont_wed[PCA4$water=='wet']),2)
# round(mean(PCA4$prob_cont_wed[PCA4$water=='dry']),2)
# print('Cluster 4: Concentrations Water')
# round(mean(PCA4$conc_mid_wed_mean[PCA4$water=='wet']),2)
# round(mean(PCA4$conc_mid_wed_mean[PCA4$water=='dry']),2)
```
